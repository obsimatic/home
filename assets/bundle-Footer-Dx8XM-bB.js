import { b as createAstro, c as createComponent, r as renderComponent, F as Fragment, a as renderTemplate, m as maybeRenderHead, e as addAttribute, u as unescapeHTML, d as renderScript, g as defineStyleVars, h as renderHead, i as renderSlot } from './bundle-astro/server-DefwwQT6.js';
import 'piccolore';
/* empty css                                */
import 'clsx';
...
async function getCategories() {
  try {
    const cats = await Promise.resolve().then(() => categories$1);
    return cats.default || {};
  } catch {
...
async function getProducts() {
  try {
    const prods = await import('./bundle-products-ClDRpmTB.js');
...
const categories = {
  "drive-servo": {"slug":"drive-servo","parentSlug":null,"order":0,"i18n":{"tr":{"name":"SÜRÜCÜ-SERVO","title":"","description":""},"en":{"name":"DRİVE-SERVO","title":"","description":""},"ar":{"name":"وحدة تحكم بسرعة المحرك - محرك","title":"","description":""}}},
  ...
  plc,
  "drive-servo>allen-bradley": {"slug":"drive-servo>allen-bradley","parentSlug":"drive-servo","order":1,"i18n":{"tr":{"name":"Allen-Bradley","title":"","description":""},"en":{"name":"Allen-Bradley","title":"","description":""},"ar":{"name":"Allen-Bradley","title":"","description":""}}},
  "drive-servo>schneider-electirc": {"slug":"drive-servo>schneider-electirc","parentSlug":"drive-servo","order":2,"i18n":{"tr":{"name":"Schneider Electirc","title":"","description":""},"en":{"name":"Schneider Electirc","title":"","description":""},"ar":{"name":"Schneider Electirc","title":"","description":""}}},
  "drive-servo>omron": {"slug":"drive-servo>omron","parentSlug":"drive-servo","order":4,"i18n":{"tr":{"name":"Omron","title":"","description":""},"en":{"name":"Omron","title":"","description":""},"ar":{"name":"Omron","title":"","description":""}}},
  "drive-servo>abb": {"slug":"drive-servo>abb","parentSlug":"drive-servo","order":3,"i18n":{"tr":{"name":"ABB","title":"","description":""},"en":{"name":"ABB","title":"","description":""},"ar":{"name":"ABB","title":"","description":""}}},
  ...
  "drive-servo>siemens": {"slug":"drive-servo>siemens","parentSlug":"drive-servo","order":0,"i18n":{"tr":{"name":"SIEMENS","title":"","description":""},"en":{"name":"SIEMENS","title":"","description":""},"ar":{"name":"SIEMENS","title":"","description":""}}},
  "drive-servo>rexroth": {"slug":"drive-servo>rexroth","parentSlug":"drive-servo","order":6,"i18n":{"tr":{"name":"Rexroth","title":"","description":""},"en":{"name":"Rexroth","title":"","description":""},"ar":{"name":"Rexroth","title":"","description":""}}},
  ...
  "drive-servo>fanuc": {"slug":"drive-servo>fanuc","parentSlug":"drive-servo","order":5,"i18n":{"tr":{"name":"FANUC","title":"","description":""},"en":{"name":"FANUC","title":"","description":""},"ar":{"name":"FANUC","title":"","description":""}}},
...
export { $$Layout as $, DEFAULT_LANGUAGE as D, SUPPORTED_LANGUAGES as S, $$Header as a, $$Footer as b, categories as c, getLocalizedPath as d, formatUrlSlug as f, getPageData as g, siteData as s };
