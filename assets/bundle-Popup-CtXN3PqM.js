import { b as createAstro, c as createComponent, m as maybeRenderHead, e as addAttribute, d as renderScript, a as renderTemplate, u as unescapeHTML, r as renderComponent } from './bundle-astro/server-DefwwQT6.js';
import 'piccolore';
import 'clsx';
import { s as siteData, d as getLocalizedPath, c as categories, f as formatUrlSlug } from './bundle-Footer-Dx8XM-bB.js';
import fs from 'node:fs';
import path from 'node:path';
/* empty css                                */
import { g as getCategoryImage } from './bundle-categoryImages-Btquvm5G.js';
import { $ as $$ProductCard } from './bundle-ProductCard-BhwkRRQP.js';
...
}, "C:/Users/ob-si/OneDrive/Desktop/ob-simatic-ekkeri/project/src/components/ServicePillars.astro", void 0);
...
const $$ProductCategories = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="products" data-astro-cid-xf6hngan> <div class="container" data-astro-cid-xf6hngan> <div class="section-title" data-astro-cid-xf6hngan> <h2 data-astro-cid-xf6hngan>${sectionTitle}</h2> <p data-astro-cid-xf6hngan>${sectionDesc}</p> </div> <div class="grid" data-astro-cid-xf6hngan> ${categories$1.map((cat) => renderTemplate`<a${addAttribute(
...
}, "C:/Users/ob-si/OneDrive/Desktop/ob-simatic-ekkeri/project/src/components/ProductCategories.astro", void 0);
...
const $$FeaturedProducts = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${featuredProducts.length > 0 && renderTemplate`${maybeRenderHead()}<section class="featured-products" data-astro-cid-izcvjprn><div class="container" data-astro-cid-izcvjprn><div class="section-header" data-astro-cid-izcvjprn><h2 data-astro-cid-izcvjprn>${sectionTitle}</h2><a${addAttribute(getLocalizedPath("/arama", lang), "href")} class="view-all-btn" data-astro-cid-izcvjprn>${viewAllText}</a></div><div class="products-grid" data-astro-cid-izcvjprn>${featuredProducts.map((product) => renderTemplate`${renderComponent($$result, "ProductCard", $$ProductCard, { "image": product.image, "brand": product.brand, "title": product.title, "code": product.id, "href": getLocalizedPath(`/${product.id}`, lang), "ui": ui, "categorySlug": product.categorySlug, "price": product.price, "data-astro-cid-izcvjprn": true })}`)}</div></div></section>`}`;
}, "C:/Users/ob-si/OneDrive/Desktop/ob-simatic-ekkeri/project/src/components/FeaturedProducts.astro", void 0);
...
const $$Manufacturers = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="manufacturers" data-astro-cid-vhoeen67> <div class="container" data-astro-cid-vhoeen67> <div class="section-title" data-astro-cid-vhoeen67> <h2 data-astro-cid-vhoeen67>${sectionTitle}</h2> </div> <div class="brand-grid" data-astro-cid-vhoeen67> ${brands.map((brand) => renderTemplate`<div class="brand-item" data-astro-cid-vhoeen67> ${brand.image && !brand.image.includes("default") ? renderTemplate`<img${addAttribute(brand.image, "src")}${addAttribute(brand.name, "alt")} class="brand-image" data-astro-cid-vhoeen67>` : renderTemplate`<span class="brand-name" data-astro-cid-vhoeen67>${brand.name}</span>`} </div>`)} </div> </div> </section> `;
}, "C:/Users/ob-si/OneDrive/Desktop/ob-simatic-ekkeri/project/src/components/Manufacturers.astro", void 0);
...
}, "C:/Users/ob-si/OneDrive/Desktop/ob-simatic-ekkeri/project/src/components/PriceList.astro", void 0);
